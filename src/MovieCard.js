import placeholder from "./assets/nophoto.jpeg";
...
const fullLang = [
  ...
  "Hiri Motu",
  "Hungarian",
  "Interlingua (International Auxiliary Language Association)ational Auxiliary Language Association)",
  "Indonesian",
  "Interlingue",
  "Irish",
  "Igbo",
  ...
  return (
    <li key={movieKey} className={cardClass}>
      <div className={cardInformation}>
        <h4>{movieTitle}</h4>
        {showOgLang ? <p>{fullLang[position1]}</p> : null}
